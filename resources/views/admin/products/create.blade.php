    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('nutritional_information') ? 'is-invalid' : '' }}" name="nutritional_information" id="nutritional_information">{{ old('nutritional_information') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('ar_nutritional_information') ? 'is-invalid' : '' }}" name="ar_nutritional_information" id="ar_nutritional_information">{{ old('ar_nutritional_information') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_type') ? 'is-invalid' : '' }}" type="text" name="product_type" id="product_type" value="{{ old('product_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ar_product_type') ? 'is-invalid' : '' }}" type="text" name="ar_product_type" id="ar_product_type" value="{{ old('ar_product_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('diet_needs') ? 'is-invalid' : '' }}" type="text" name="diet_needs" id="diet_needs" value="{{ old('diet_needs', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ar_diet_needs') ? 'is-invalid' : '' }}" type="text" name="ar_diet_needs" id="ar_diet_needs" value="{{ old('ar_diet_needs', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ar_specialty') ? 'is-invalid' : '' }}" type="text" name="ar_specialty" id="ar_specialty" value="{{ old('ar_specialty', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('package_dimensions') ? 'is-invalid' : '' }}" type="text" name="package_dimensions" id="package_dimensions" value="{{ old('package_dimensions', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ar_package_dimensions') ? 'is-invalid' : '' }}" type="text" name="ar_package_dimensions" id="ar_package_dimensions" value="{{ old('ar_package_dimensions', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('package_weight') ? 'is-invalid' : '' }}" type="text" name="package_weight" id="package_weight" value="{{ old('package_weight', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ar_package_weight') ? 'is-invalid' : '' }}" type="text" name="ar_package_weight" id="ar_package_weight" value="{{ old('ar_package_weight', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('storage_requirements') ? 'is-invalid' : '' }}" type="text" name="storage_requirements" id="storage_requirements" value="{{ old('storage_requirements', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ar_storage_requirements') ? 'is-invalid' : '' }}" type="text" name="ar_storage_requirements" id="ar_storage_requirements" value="{{ old('ar_storage_requirements', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('origin_country') ? 'is-invalid' : '' }}" type="text" name="origin_country" id="origin_country" value="{{ old('origin_country', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ar_origin_country') ? 'is-invalid' : '' }}" type="text" name="ar_origin_country" id="ar_origin_country" value="{{ old('ar_origin_country', '') }}">
